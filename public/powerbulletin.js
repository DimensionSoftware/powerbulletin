...
require.define("/app/mutants.ls",function(require,module,exports,__dirname,__filename,process,global){(function(){
  var layoutStatic, flipBackground, domInsert;
  ...
  domInsert = function(w, target, view){
    var $t, $b;
    $t = w.$(target);
  ...
  this.forum = {
    'static': function(window, next){
      ...
      if (m) {
        id = m[1] || 0;
        id = id ? "subpost_" + id : 'BOTTOM';
        domInsert(window, id, 'edit_post');
      }
      return next();
    },
    onLoad: function(window, next){
...
require.define("/app/entry.ls",function(require,module,exports,__dirname,__filename,process,global){(function(){
  ...
  window.loadUi = function(){
    var s, ref$, searching, collapsed, w;
    s = $.cookie('s');
    if (s) {
      ref$ = s.split(sep), searching = ref$[0], collapsed = ref$[1], w = ref$[2];
