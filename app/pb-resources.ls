    ...
    | \menu =>
      ...
      if id # active form
        form = { [k, v] for k,v of req.body when k in
          <[ id dbid title placeholderDescription productContent productContentOnly productDescription affiliateLink hashtags videoTop videoBottom linkDescription forumDescription pageDescription dialog postsPerPage productSlug forumSlug locked comments pageSlug content url contentOnly separateTab ]> }
